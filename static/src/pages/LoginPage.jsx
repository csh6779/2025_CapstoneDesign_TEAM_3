...
function LoginPage() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // ✅ 여기서만 role 관련 변수 선언
            const backendRoleRaw = data.Role || data.role || 'user';
            const normalizedRole = String(backendRoleRaw).toLowerCase();
            ...
            console.log('로그인 성공:', {
                ...
                rawRole: backendRoleRaw,
                normalizedRole: normalizedRole,
            });

            // ✅ 여기서 normalizedRole 사용
            ...
            console.log('백엔드에서 받은 역할(raw):', backendRoleRaw);
        } catch (err) {
